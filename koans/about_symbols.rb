...
class AboutSymbols < Neo::Koan
  ...
  #
  # Response: If symbols were used in the comparison, they would be created 
  #           before the include? method is evaluated, and therefore the 
  #           include? method would always return true.
